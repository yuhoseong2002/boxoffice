  ...
  return (
    <div className={`min-h-screen font-sans flex flex-col transition-colors duration-200 ${
      ...
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-12 overflow-hidden items-stretch">
        ...
        <section className={`lg:col-span-5 relative group border-b lg:border-b-0 lg:border-r flex flex-col justify-between ${
        ...
        <section className={`lg:col-span-7 p-6 overflow-hidden flex flex-col justify-between ${
